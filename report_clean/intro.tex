...
Another interesting case is $\omega_p^2(\mathbf{r})+\omega_c^2(\mathbf{r})=\omega^2$, when the diagonal part of the tensor 
$\underline{\varepsilon}_{\omega}^{0}(\mathbf{r})$ vanishes, 
