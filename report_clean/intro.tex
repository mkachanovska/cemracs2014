...
integrable (for an illustrative example of such a system in one dimension see \cite{Despres_2014}). This apparent paradox is of course the source of important numerical difficulties which are the subject of the present study. 
...
in the frequency domain, with $\omega=\omega_{*}$ and the boundary condition $\left.\partial_x \hat{E}_y\right|_{x=-L}=1$. For more details see e.g. \cite{Morawetz, Eidus}. The commutation between the two principles then write as}
$$
