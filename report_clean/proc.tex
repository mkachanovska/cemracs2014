...
\begin{document}
\newcommand{\urev}[1]{{\color{blue}#1}}
\newcommand{\arev}[1]{{\color{red}#1}}
\newcommand{\mrev}[1]{{\color{green}#1}}
...
Despr\'es, B., Imbert-G\'erard, L.-M. and Lafitte, O.. Singular solutions for the plasma at the resonance. 2014. <hal-01097364>
