...
\end{align}
\mrev{As we remark a bit further, such a choice of parameters for the problem (\ref{eq:main_frequency_domain}) with $\theta=0$ will allow 
us to obtain the solution in the analytic form}.
