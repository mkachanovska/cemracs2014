...
\end{align}
\mrev{
We consider the following generalized model of the above system
\begin{align}
\label{eq:main_frequency_domain_general}
\left(
\begin{matrix}
 i\theta \partial_x \hat{E}_y+\theta^2 \hat{E}_x\\
 i\theta \partial_x \hat{E}_x -\partial_x^2 \hat{E}_y
...
\mrev{In this section we study the well-posedness of the problem (\ref{eq:main_frequency_domain_general}) with the help of Lax-Milgram lemma.} 
