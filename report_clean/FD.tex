...
We have }
\ben
 \textcolor{red}{\epsilon_{\nu}(\omega)\approx \epsilon_0+i\nu Id,\; \nu\rightarrow 0.}
\een

\textcolor{red}{Thus, we finally obtain a simpler equation \cite{Despres_2014}, with the notation adopted from now on that $\epsilon_0(x) = \epsilon (x)$ }
\begin{align}
