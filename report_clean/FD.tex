...
\bealn
 ...
 \delta^{\nu}_{\omega}=\delta_{\omega}-i\nu\frac{2\omega_c\omega_p^2}{(\omega^2-\omega_c^2)^2}=\alpha_{\omega}+i\nu D_{\delta},
\eealn
...
\end{align*}
\mrev{
For simplicity, from now on we will denote $\alpha_{\omega},\; \delta_{\omega}$ by $\alpha,\; \delta$ and consider a sequence of regularized problems. 
\begin{align}
...
\right),
\end{align}
where $\alpha,\;\delta$ satisfy the following.
}
\urev{
\begin{assumption}
...
corresonding limiting solutions differ, though both exhibit the singularity in the point of the hybrid resonance.  
\end{remark}
}
...
\begin{proof}
	...
	Without loss of generality let us assume that $\nu>0$. \mrev{Given $\heps$ the spectral radius of $\varepsilon^{0}$, 
