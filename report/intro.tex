...
\end{split}
\end{align}
It is known \cite{} that when the term $\nu=0$, the electron density $N_e(x)$ vanishes and in plasma there occurs a resonance \cite{Stix}, 
which was recently investigated in \cite{}. It can be shown that the electric field $E_x$ in this case is no longer square 
integrable \cite{}. 
