...
\frac{\epsilon_0 |\E(t,\x)|^2}{2}+\frac{ |\B(t,\x)|^2}{2\mu_0}+\frac{m_e|\J (t,\x)|}{2|e|N_e(\x)} 
\right)\mathrm{d}\x.
\end{align*}
So if the electron density $N_e(x)$ vanishes, 
...
in particular, it was shown that the electric field component $E_x$ in this case is no longer square 
integrable, and explicit estimates on the behaviour of the solutions of \eqref{eq:main_model} in 1D were provided. 
