...
\end{figure}
The $L_2$-error (\ref{eq:error}) 
on the time interval $()$ did not exceed $0.16$ for $E_x(x,t)$ and $0.085$ for $E_y(x,t)$.


The results for $\nu=10^{-3}$ are demonstrated in Figure \ref{}.
\begin{figure}
 
\end{figure}


As we can see, the two solutions though being similar, 
