...
with a a bilinear form $a$ and a linear form $l$  %such tare such that
\be
...
\begin{proof}
	...
	%\geq \frac{1}{2}\| u_2' \|^2_{L^2}-  3 \theta^2 \|u_1 \|^2_{L^2}.
	%\end{array}
	%\ee
	Thus one can write
	$
	...
	Therefore
	\ben
	\left(  1+  \frac{\heps  +  \theta^2}\nu  \right)\left| a(\ubf,\ubf) \right| \geq
	a_1(\ubf,\ubf)+\frac{\heps  +  \theta^2}\nu a_2(\ubf,\ubf) \geq  \frac12 \|u_2 '  \|_{L^ 2}^ 2
	\een
	and
	\ben
	\left(  1+  \frac{\heps  +  \theta^2}\nu + \frac1\nu \right) \left|a(\ubf,\ubf)\right| \geq\frac12 \|u_2 '  \|_{L^ 2}^ 2
	+
	\| \ubf \|_{L^2}^2.
	\een
	...
	%\be
	%\begin{array}{ll}
	%|a(\ubf,\ubf)| & \geq \frac12  |a_1(\ubf,\ubf)| +\frac12  |a_2(\ubf,\ubf)| \\
	%& \geq \frac12  a_1(\ubf,\ubf)  +\frac12  a_2(\ubf,\ubf) \\ 
	%% &\geq \left| \frac{1}{2}\|u_2' \|^2_{L^2} - (\heps + \theta^2) \|\ubf\|^2_{L^2}\right|^2+ \nu^2\|\ubf\|^2_{L^2}\\
	%&\geq \frac{1}{4}\|u_2'\|_{L^2}^2 - (\heps + \theta^2) \|u_2'\|^2_{L^2} \|\ubf\|^2_{L^2} + \left( (\heps + \theta^2) + \nu \right) \| \ubf\|^4_{L^2}.
	%\end{array} 
	%\ee
	%%We obtain
	%%\be
	...
	%\end{array}
	%\ee
	%In order to satisfy NOT VERY CLEAR 
	%\be
