...
\end{align*}
Then the limiting absorption principle can be obtained leaving only the diagonal terms ??NOT CLEAR in the above expansion (see \cite{Despres_2014}):
\begin{align}
...
\begin{remark} VERY UNCLEAR: WHY INTRODUCING M  IF WE NEVER USE IT ? CAN WE SAY WHEN IT ACTUALLY IS AN ISOMORPHISM ? FORWARD REFERENCE ?
...
MENTION THE BASIS FUNCTIONS HERE ?
