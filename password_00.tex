...
\ee
We note $\heps =  \max\left( \| \lambda_1 \|_{L^\infty}, \| \lambda_2\|_{L^\infty}\right)$, where $ \lambda_1 $ and $\lambda_2$ are the eigenvalues of $\eps_0$. Then the eigenvalues of $\heps Id- \eps_0$ are $\heps - \lambda_1$, $\heps - \lambda_2$.
...
\be
\begin{array}{l}
| a(\ubf, \ubf) |^2 = \frac{1}{4} \| u_2'\|_{L^2}^2 - (\heps + \theta^2) \left( \frac{\sigma^2}{2}\|u_2'\|_{L^2}^4 \right) - (\heps + \theta^2) \left( \frac{\|\ubf\|^4_{L^2}}{2\sigma^2} \right) \\
+ \left( (\heps + \sigma^2) + \nu^2 \right) \|\ubf \|^4_{L^2}\\
= \left( \frac{1}{4}- \frac{(\heps + \theta^2)\sigma}{2}\right)\|u_2'\|_{L^2}^4 + \left(\left((\heps + \theta^2) + \nu^2\right) - \frac{(\heps + \theta^2)}{2\theta^2}\right) \|\ubf\|_{L^2}^4
\end{array}
\ee
We chose $\sigma$ such that 
\be
...
\end{array}
\ee
The we have the following minoration for $a$
\be 
