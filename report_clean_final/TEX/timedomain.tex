...
% \end{align}
We compute a numerical approximation of~\eqref{eq:main_model} with $\theta=0$ on a cartesian grid using the Yee scheme, 
...
of $E_x$, $u_x$ (black dots), $E_y$, $u_y$ (blue dots) and $H_z$ (red dots) 
