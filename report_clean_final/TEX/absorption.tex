...
\begin{figure}[htb]
\begin{tabular}{cc}
\includegraphics[width=0.45\textwidth]{pics_time_domain/airy/figure_nu1e2-crop.pdf} & \includegraphics[height=0.168\textwidth]{pics_time_domain/airy/figure_nu1e2_2-crop.pdf}
\end{tabular}
...
\ref{fig:resonance_nus_ex_x},  \ref{fig:resonance_nus_ey_t}, \ref{fig:resonance_nus_ex_t}, \ref{fig:resonance_nus_eyx_t}. 
\begin{table}[htb!]
\begin{tabular}{l|l}
Parameter & Value \\
\hline
...
\nrev{We can see that the limiting amplitude solution had been achieved, and the difference between the solutions computed in 
...
Figures \ref{fig:resonance_nus_ey_t}, \ref{fig:resonance_nus_ex_t}, \ref{fig:resonance_nus_eyx_t} show that in the case of the resonance
\nrev{the limiting amplitude solution is achieved}, and both \nrev{limiting amplitude and limited absorption solutions} are in close agreement (but in the points close to a point where the resonance occurs).
