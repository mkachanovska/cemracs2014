...
\begin{itemize}
 \item \lastrev{The C\'ea lemma} applied to the problem (\ref{vf1dcase}); here \mrev{$\mathbf{E}^{\nu}$ is the exact solution, 
...
The numerical tests have been kept to a minimum, and \arev{many more} are needed to fully validate
the concept.
...
\urev{Notice that in this case we shifted the computational domain is shifted
