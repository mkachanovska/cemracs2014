...
% any open problems exist which prevent for having
%a mathematically sound multidimensional theory  of hybrid resonance.
% is an open problem.
...
%curl
 {\operatorname{curl}} \
  \hat{\mathbf{E}} \mrev{+}i \lambda\hat{\mathbf{E}}\wedge \n = \hat{g}_{inc} \equiv
   {\operatorname{curl}} \ \E_{inc} \mrev{+} i  \lambda\E_{inc}\wedge \n,
\ee
where $\E_{inc} = \exp \left(i  \lambda x\right)\begin{pmatrix} E_1\\ E_2 \end{pmatrix}$ and \mrev{$\lambda\geq 0$} is 
